...
|---|---|---|
| localStorage | Entries (with thumbnails), autosaved draft, settings, imported site list, selected park, recent questions, tank check, personnel, audit team, prior audit | `nps_saved`, `nps_current`, `nps_photo_settings`, `nps_site_list`, `nps_selected_park`, `nps_recent_tg`, `nps_tanks`, `nps_people`, `nps_audit`, `nps_prior`, `nps_loc_sites` |
